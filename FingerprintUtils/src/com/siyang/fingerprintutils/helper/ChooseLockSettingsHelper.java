...
package com.siyang.fingerprintutils.helper;
...
public final class ChooseLockSettingsHelper {
    ...
    private boolean confirmPattern(int request, CharSequence message,
        ...
        ComponentName cn = new ComponentName("com.android.settings", returnCredentials?
        		"com.android.settings.ConfirmLockPattern$InternalActivity"
        		:"com.android.settings.ConfirmLockPattern");
        intent.setComponent(cn);
        Log.i("Intent",intent.getComponent().getClassName());
        if (mFragment != null) {
    ...
    private boolean confirmPassword(int request, CharSequence message,
        ...
        intent.putExtra(ConfirmLockPattern.HEADER_TEXT, message);
        ComponentName cn = new ComponentName("com.android.settings", returnCredentials?
        		"com.android.settings.ConfirmLockPassword$InternalActivity"
